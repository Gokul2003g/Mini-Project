...
!(function (a, b) {
  ...
  function e(a) {
    ...
    return (
      p / l >= 0.75 && (k = Math.floor(0.75 * k * (l / p))),
      (b.font = "bold " + k * f + "px " + n),
      b.fillText(o, l / 2, m / 2, l),
  ...
  function h(a, b, c, d) {
    ...
    (f = h ? o(f, {text: h}) : f),
      (f = c.font ? o(f, {font: c.font}) : f),
      b.setAttribute("data-src", d),
      (c.theme = f),
      (b.holder_data = c),
      "image" == a
        ? (b.setAttribute("alt", h ? h : f.text ? f.text + " [" + i + "]" : i),
          (r.use_fallback || !c.auto) &&
            ((b.style.width = e.width + "px"),
            (b.style.height = e.height + "px")),
          r.use_fallback
            ? (b.style.backgroundColor = f.background)
            : (b.setAttribute(
                "src",
                g({ctx: w, dimensions: e, template: f, ratio: x, holder: c})
              ),
              c.textmode && "exact" == c.textmode && (v.push(b), k(b))))
        : "background" == a
        ? r.use_fallback ||
          ((b.style.backgroundImage =
            ...
            g({ctx: w, dimensions: e, template: f, ratio: x, holder: c}) +
            ")"),
          (b.style.backgroundSize = e.width + "px " + e.height + "px"))
        : "fluid" == a &&
          (b.setAttribute("alt", h ? h : f.text ? f.text + " [" + i + "]" : i),
          "%" == e.height.slice(-1)
  ...
  function i(a, b) {
    ...
    return c.height || c.width
      ...
      : (a.setAttribute("data-holder-invisible", !0), void b.call(this, a));
  }
  function j(b) {
    if (b.holder_data) {
      ...
      if (c) {
        var d = b.holder_data;
        (d.initial_dimensions = c),
          (d.fluid_data = {
            fluid_height: "%" == d.dimensions.height.slice(-1),
            fluid_width: "%" == d.dimensions.width.slice(-1),
            mode: null,
          }),
          d.fluid_data.fluid_width && !d.fluid_data.fluid_height
            ? ((d.fluid_data.mode = "width"),
              (d.fluid_data.ratio =
                d.initial_dimensions.width / parseFloat(d.dimensions.height)))
            : !d.fluid_data.fluid_width &&
              d.fluid_data.fluid_height &&
              ((d.fluid_data.mode = "height"),
              (d.fluid_data.ratio =
                parseFloat(d.dimensions.width) / d.initial_dimensions.height));
      }
    }
  }
  function k(b) {
  ...
  function l(b, c) {
    for (
      var d = {theme: o(y.themes.gray, {})}, e = !1, f = b.length, g = 0;
      f > g;
      g++
    ) {
      var h = b[g];
      a.flags.dimensions.match(h)
        ? ((e = !0), (d.dimensions = a.flags.dimensions.output(h)))
        : a.flags.fluid.match(h)
        ? ((e = !0), (d.dimensions = a.flags.fluid.output(h)), (d.fluid = !0))
        : a.flags.textmode.match(h)
        ? (d.textmode = a.flags.textmode.output(h))
        : a.flags.colors.match(h)
        ? (d.theme = a.flags.colors.output(h))
        : c.themes[h]
        ? c.themes.hasOwnProperty(h) && (d.theme = o(c.themes[h], {}))
        : a.flags.font.match(h)
        ? (d.font = a.flags.font.output(h))
        : a.flags.auto.match(h)
        ? (d.auto = !0)
        : a.flags.text.match(h) && (d.text = a.flags.text.output(h));
    }
    return e ? d : !1;
  }
  function m(a, b) {
    var c = "complete",
      ...
      m = function (g) {
        (g.type != d || h.readyState == c) &&
          (("load" == g.type ? a : h)[k](l + g.type, m, e),
          !f && (f = !0) && b.call(a, null));
      },
      n = function () {
        try {
  ...
  var q = {use_svg: !1, use_canvas: !1, use_fallback: !1},
    r = {},
    s = !1;
      ...
      return (
        ...
        function (b) {
          return (
            ...
            e.setAttribute("width", b.width),
            e.setAttribute("height", b.height),
            e.setAttribute("fill", b.template.background),
            f.setAttribute("x", b.width / 2),
            f.setAttribute("y", b.height / 2),
            (g.nodeValue = b.text),
            f.setAttribute(
              "style",
              d({
  ...
  for (var A in a.flags)
    a.flags.hasOwnProperty(A) &&
      (a.flags[A].match = function (a) {
  ...
  (a.invisible_error_fn = function () {
    ...
    (a.run = function (b) {
      ...
      for (
        null != c.use_canvas &&
          c.use_canvas &&
          ((r.use_canvas = !0), (r.use_svg = !1)),
          "string" == typeof c.images
            ? (e = n(c.images))
            : window.NodeList && c.images instanceof window.NodeList
            ? (e = c.images)
            : window.Node && c.images instanceof window.Node
            ? (e = [c.images])
            : window.HTMLCollection &&
              c.images instanceof window.HTMLCollection &&
              (e = c.images),
          "string" == typeof c.bgnodes
            ? (f = n(c.bgnodes))
            : window.NodeList && c.elements instanceof window.NodeList
            ? (f = c.bgnodes)
            : window.Node &&
              c.bgnodes instanceof window.Node &&
              (f = [c.bgnodes]),
          k = 0,
          j = e.length;
        j > k;
      ...
      g ||
        ...
        g.setAttribute("id", "holderjs-style"),
        (g.type = "text/css"),
        document.getElementsByTagName("head")[0].appendChild(g)),
        c.nocss ||
          (g.styleSheet
            ? (g.styleSheet.cssText += c.stylesheet)
            : g.appendChild(document.createTextNode(c.stylesheet)));
      for (
        var i = new RegExp(c.domain + '/(.*?)"?\\)'), j = f.length, k = 0;
        j > k;
        k++
      ) {
        var m = window
            .getComputedStyle(f[k], null)
        ...
        if (p) {
          ...
          var u = l(
            t.substr(t.lastIndexOf(c.domain) + c.domain.length + 1).split("/"),
            c
          );
          u && h("background", f[k], u, m);
        }
      ...
      for (j = d.length, k = 0; j > k; k++) {
        ...
        w = v = m = null;
        try {
          (w = d[k].getAttribute("src")),
            (attr_datasrc = d[k].getAttribute("data-src"));
        } catch (x) {}
        if (
          (null == attr_datasrc && w && w.indexOf(c.domain) >= 0
            ? (m = w)
            : attr_datasrc &&
              attr_datasrc.indexOf(c.domain) >= 0 &&
              (m = attr_datasrc),
          m)
        ) {
          var u = l(
            m.substr(m.lastIndexOf(c.domain) + c.domain.length + 1).split("/"),
            c
          );
        ...
        b.btoa ||
          (b.btoa = function (b) {
            for (
              var d, e, f = 0, g = c, h = "";
              b.charAt(0 | f) || ((g = "="), f % 1);
              h += g.charAt(63 & (d >> (8 - 8 * (f % 1))))
            ) {
              if (((e = b.charCodeAt((f += 0.75))), e > 255))
        ...
        b.atob ||
          (b.atob = function (b) {
            ...
            for (
              var d, e, f = 0, g = 0, h = "";
              (e = b.charAt(g++));
              ~e && ((d = f % 4 ? 64 * d + e : e), f++ % 4)
                ? (h += String.fromCharCode(255 & (d >> (6 & (-2 * f)))))
                : 0
            )
              e = c.indexOf(e);
            return h;
